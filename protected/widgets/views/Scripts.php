    ...
    <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->params['resourceUrl']; ?>/css/style.css?version=<?php echo Yii::app()->params['version']?>" />
	...
	<script src="<?php echo Yii::app()->params['resourceUrl']; ?>/js/scripts.js?version=<?php echo Yii::app()->params['version']?>"></script>
	<!-- colorbox js and css -->
