...
<head>
	...
	<title>MOS</title>
	<meta name="description" content="MOS - The Malayalam Matrimonial Site. Thousands of Kerala Brides & Grooms. Register free" />
    <meta name="keywords" content="MOS, Matrimony, Marriage, Wedding, Malayalam Matrimony, Kerala Matrimonial, Kerala Matrimonials, Kerala Matrimony " />
	<meta name="google-site-verification" content="">
	<meta name="author" content="MOS">
	<meta name="Copyright" content="MOS">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0">
	<link rel="shortcut icon" href="http://natarajanonline.com/mos/images/favicon.ico">
    <link rel=icon type="image/ico" href="http://natarajanonline.com/mos/images/favicon.ico">
    <link href='http://fonts.googleapis.com/css?family=Roboto+Condensed:400,300,700' rel='stylesheet' type='text/css'>
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->params['resourceUrl']; ?>/css/style.css" />
	...
	<script src="<?php echo Yii::app()->params['resourceUrl']; ?>/js/scripts.js"></script>
